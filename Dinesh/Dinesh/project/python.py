...
class homepage:
    def __init__(self,root):
        ...
        self.bg=PhotoImage(file="G:\lpu\Sem III\INT213\project\Dinesh\Dinesh\project\images\home1.png")
        ...
        self.bg_home=PhotoImage(file="G:\lpu\Sem III\INT213\project\Dinesh\Dinesh\project\images\home2.png")
        ...
        self.bg_doctoricon=PhotoImage(file="G:\lpu\Sem III\INT213\project\Dinesh\Dinesh\project\images\doctoricon.png")
        ...
        self.bg_patienticon=PhotoImage(file="G:\lpu\Sem III\INT213\project\Dinesh\Dinesh\project\images\patienticon.png")
        ...
        self.bg_appointmenticon=PhotoImage(file="G:\lpu\Sem III\INT213\project\Dinesh\Dinesh\project\images\calendericon.png")
        ...
        self.bg_admiticon=PhotoImage(file="G:\lpu\Sem III\INT213\project\Dinesh\Dinesh\project\images\dmiticon.png")
        ...
        self.bg_exiticon=PhotoImage(file="G:\lpu\Sem III\INT213\project\Dinesh\Dinesh\project\images\exiticon.png")
...
conn=pymysql.connect(host="localhost",user="root",password="DineshSQL@",database="hospital")
cur=conn.cursor()
...
// creating tables in hospital database 

create table login(username varchar(30), password varchar(30));

create table doctor(specialization varchar(50), doctor_name varchar(50), address varchar(50),fee int, contact_no int, email varchar(50), joining_date datetime);



create table specialization(specialization varchar(30),creation_date datetime);


create table patient(patient_name varchar(255), Gender varchar(50),DOB date, contact varchar(255),email varchar(50),address varchar(60),symptoms varchar(255), specification varchar(100), doctor varchar(100) , apt_date date , apt_time time );